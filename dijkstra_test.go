...
func TestDijkstra1(t *testing.T) {
	g := NewGraph()
	nodes := NodeList{g.AddNode(0), g.AddNode(1), g.AddNode(2), g.AddNode(3)}
...
func TestDijkstra4(t *testing.T) {
	g := NewGraph()
	nodes := NodeList{g.AddNode(0), g.AddNode(1), g.AddNode(2)}
	g.AddEdge(nodes[0], nodes[1], 1)
...
func TestDijkstra5(t *testing.T) {
	g := NewGraph()
	nodes := NodeList{g.AddNode(0), g.AddNode(1)}
